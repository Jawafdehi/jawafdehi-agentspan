...
All source documents (charge sheet, CIAA press release, court order, news articles) are
provided inline in the prompt. Do not attempt to read files, write files, or call any tools.
